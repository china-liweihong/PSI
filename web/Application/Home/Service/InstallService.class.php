...
class InstallService extends PSIBaseExService {
	...
	private function insertInitData() {
		...
		$sql = "INSERT INTO `t_permission` (`id`, `fid`, `name`, `note`, `category`, `py`, `show_order`) VALUES
				...
				('2034-06', '2034-06', '新增工厂', '按钮权限：供应商档案模块[新增工厂]按钮权限', '工厂', 'XZGYS', 204),
				('2034-07', '2034-07', '编辑工厂', '按钮权限：供应商档案模块[编辑工厂]按钮权限', '工厂', 'BJGYS', 205),
				('2034-08', '2034-08', '删除工厂', '按钮权限：供应商档案模块[删除工厂]按钮权限', '工厂', 'SCGYS', 206),
